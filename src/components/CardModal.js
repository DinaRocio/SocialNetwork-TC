      ...
      <form className="card-form">
        ...
        <ul className="comments_group">
          <li className="comments_item">
            ...
            <div className="comment">Lorem Ipsum is simply dummy text of the</div>
          </li>
          <li className="comments_item">
            <div className="colaborator_picture">
              <img
        ...
        <input className="comment-input_input" name="comment" type="text" placeholder="Type comment here..." />
      </form>
    </div>
  );
}
